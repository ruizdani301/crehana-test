...
def mock_user_repo(monkeypatch):
    ...
    monkeypatch.setattr("infrastructure.db.user_repository.get_user_by_username", mock.get_user_by_username)
    monkeypatch.setattr("infrastructure.db.user_repository.create_user", mock.create_user)
